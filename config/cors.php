...
return [
    ...
    'allowed_origins' => array_filter(array_map('trim', explode(',', env('CORS_ALLOWED_ORIGINS', 'http://localhost:3000,https://library-dashboard-product.name-fghfg12.workers.dev,http://localhost:5173,http://127.0.0.1:3000,http://127.0.0.1:5173,http://localhost:8081')))),
